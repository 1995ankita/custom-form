            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form method="POST" action="{{ route('form.update', $customField->id) }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="link_field" class="form-control" name="link_field" value="{{ old('link_field', json_decode($customField->configdata)->link_field) }}">
                                </div>
